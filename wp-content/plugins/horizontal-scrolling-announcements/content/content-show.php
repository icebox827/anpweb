	...
	<div class="tool-box">
		...
		<form name="frm_hsas_display" method="post">
			<table width="100%" class="widefat" id="straymanage">
				<thead>
					<tr>
						<th scope="col" width="60%"><?php echo __( 'Announcement', 'horizontal-scrolling-announcements' ); ?></th>
						<th scope="col"><?php echo __( 'Group', 'horizontal-scrolling-announcements' ); ?></th>
						<th scope="col"><?php echo __( 'Order', 'horizontal-scrolling-announcements' ); ?></th>
						<th scope="col"><?php echo __( 'Date', 'horizontal-scrolling-announcements' ); ?></th>
					</tr>
				</thead>
				<tfoot>
					<tr>
						...
						if(count($myData) > 0) {
							...
							?>
								<tr class="<?php if ($i&1) { echo'alternate'; } else { echo ''; }?>">
									...
									<td><?php echo $data['hsas_order']; ?></td>
									<td>
									...
									<?php echo __( 'End   : ', 'horizontal-scrolling-announcements' ); ?> <?php echo $data['hsas_dateend']; ?>, <?php echo hsas_cls_common::hsas_convert_time($data['hsas_timeend']); ?>
									</td>
								</tr>
							<?php
								$i = $i+1;
