...
if (isset($_POST['hsas_form_submit']) && $_POST['hsas_form_submit'] == 'yes') {
	...
	$form['hsas_role_content'] 	= isset($_POST['hsas_role_content']) ? $_POST['hsas_role_content'] : '';
	$form['hsas_role_setting'] 	= isset($_POST['hsas_role_content']) ? $_POST['hsas_role_content'] : '';
